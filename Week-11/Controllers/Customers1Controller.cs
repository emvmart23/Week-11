...
namespace Week_11.Controllers
{
    public class Customers1Controller : Controller
    {
        ...
        public Customers1Controller(FirstContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Customer != null ? 
                          ...
                          Problem("Entity set 'FirstContext.Customer'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'FirstContext.Customer'  is null.");
            }
            var customer = await _context.Customer.FindAsync(id);
            if (customer != null)
            {
